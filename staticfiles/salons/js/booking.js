...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function saveBookingFormData() {
        const formData = {
            ...
            barber: selectedBarberInput.value || 'any',
    ...
    function updateTotalPriceAndDuration() {
        ...
        document.getElementById('total-price').innerText = totalPrice + ' драм';
        document.getElementById('total-duration').innerText = totalDuration + ' минут';
    }
